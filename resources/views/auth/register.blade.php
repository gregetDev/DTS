                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-xl-4">
                                        ...
                                        <input id="nama_universitas" type="text" class="form-control @error('nama_universitas') is-invalid @enderror" name="nama_universitas" value="{{ old('nama_universitas') }}" required>
